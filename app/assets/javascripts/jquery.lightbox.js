...
(function($) {
	$.fn.lightbox = function(options) {
		...
		*/
		function initialize() {
			$('#overlay, #lightbox_loading').remove();
			...
			var outerImage = '<div id="outerImageContainer"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav"><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="lightbox_loading"><a href="javascript://" id="loadingLink"><img src="'+opts.fileLoadingImage+'"></a></div></div></div>';
		...
		*/
		...
		$.fn.lightbox.defaults = {
		  triggerEvent: "click",
			...
			displayHelp: false,
			strings: {
				help: ' \u2190 / P - 上一图\u00a0\u00a0\u00a0\u00a0\u2192 / N - 下一图\u00a0\u00a0\u00a0\u00a0ESC / X - 关闭预览',
				prevLinkTitle: '上一图',
				nextLinkTitle: '下一图',
				prevLinkText:  '&laquo; 上一图',
				nextLinkText:  '下一图 &raquo;',
				closeTitle: '关闭',
				image: '图片 ',
				of: ' 共 ',
				download: '下载'
